...
## Initiation
- Run `ah specs list --domains-only` to list all domains to get full observability to the roadmap's initiatives
- If a specific milestone name is not provided:
  - Ask the user which initiative domain this new milestone will belong to.
...
- Run `ah specs list --domain <domain_name>` to list all milestones in the domain to get full observability to the roadmap's initiatives, and read those that this milestone may depend on.
