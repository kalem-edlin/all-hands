...
[ref:docs/harness/README.md::bc59166]
...
[ref:docs/flows/README.md::bc59166]
...
[ref:docs/agents/README.md::bc59166]
...
[ref:docs/sync-cli/README.md::bc59166]

## Cross-Domain Relationships

- **Agents reference Flows**: Each agent profile in [ref:docs/agents/README.md::bc59166] points to a flow file that defines its behavior from [ref:docs/flows/README.md::bc59166]
- **Harness executes Agents**: The spawn command [ref:docs/harness/cli/spawn-command.md::bc59166] loads agent profiles, and the event loop [ref:docs/harness/event-loop.md::bc59166] orchestrates prompt dispatch
- **Hooks enforce Flows**: Context hooks [ref:docs/harness/hooks/context-hooks.md::bc59166] and validation hooks [ref:docs/harness/hooks/validation-hooks.md::bc59166] enforce flow directives at the tool level
- **Sync distributes Harness**: The sync CLI [ref:docs/sync-cli/README.md::bc59166] packages and distributes the harness to target repositories
- **Knowledge connects everything**: The knowledge command [ref:docs/harness/cli/knowledge-command.md::bc59166] indexes docs, solutions, and memories for semantic discovery across all domains
