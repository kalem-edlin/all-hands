...
[ref:.allhands/harness/src/hooks/observability.ts::d7e4a93] provides structured logging across every hook event type. Each handler logs to the trace store via [ref:.allhands/harness/src/lib/trace-store.js:logEvent].
