...
all-hands syncs agent configurations via file distribution rather than git submodules. Source repo maintains canonical configs; consumer repos receive copies. Bidirectional flow: consumers pull updates, push improvements back.
