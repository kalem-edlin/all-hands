...
CLI tool for distributing all-hands agentic harness configurations across repositories via manifest-based file sync. Enables consumers to receive upstream updates and contribute improvements back via GitHub PRs.
